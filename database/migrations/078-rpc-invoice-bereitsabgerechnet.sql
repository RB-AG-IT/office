-- Migration 078: bereitsAbgerechnet in calculation_data speichern
-- Für EA-Rechnungen: ZA-Abzüge werden in der Rechnung gespeichert
        ...
        IF jsonb_array_length(COALESCE(input_data->'sondierungPositionen', '[]'::JSONB)) > 0 THEN
            INSERT INTO invoices (
                ...
                jsonb_build_object(
                    ...
                    'bereitsAbgerechnetSumme', COALESCE(input_data->'bereitsAbgerechnetSumme', '0')
                )
        ...
        LOOP
            INSERT INTO invoices (
                ...
                jsonb_build_object(
                    ...
                    'bereitsAbgerechnetSumme', COALESCE(v_rechnung->'bereitsAbgerechnetSumme', '0')
                )
            ) RETURNING id INTO v_new_invoice_id;
...
COMMENT ON FUNCTION create_drk_invoice IS 'Erstellt DRK-Kundenrechnungen (Zusammen oder Getrennt) - inkl. bereitsAbgerechnet für EA';
