-- ============================================================================
-- Migration 027: Trigger für Erhöhungen anpassen
-- Bei record_type='erhoehung' wird increase_amount statt yearly_amount verwendet
-- ============================================================================

-- ============================================================================
-- 1. TRIGGER: Record INSERT (mit Erhöhungs-Logik)
-- ============================================================================
...
BEGIN
    ...
    IF NEW.record_type = 'erhoehung' THEN
        -- Erhöhung: increase_amount verwenden
        v_jahreseuros := COALESCE(NEW.increase_amount, 0);
    ELSE
        -- Neumitglied: yearly_amount verwenden
...
-- ============================================================================
-- 2. TRIGGER: Record UPDATE (mit Erhöhungs-Logik)
-- ============================================================================
...
BEGIN
    -- Betrag je nach Record-Typ bestimmen (OLD)
    ...
    -- Betrag je nach Record-Typ bestimmen (NEW)
    IF NEW.record_type = 'erhoehung' THEN
    ...
    -- ========== BETRAGS-ÄNDERUNG (yearly_amount oder increase_amount) ==========
...
-- ============================================================================
-- 3. TRIGGER: Record DELETE (unverändert, arbeitet mit bestehenden Ledger-Einträgen)
-- ============================================================================
