-- Migration: Transaktionssichere Invoice-Erstellung
-- Datum: 2026-01-17
-- Beschreibung: RPC-Funktion für atomare Abrechnungserstellung
...
BEGIN
    ...
    -- 3. Provisions-Ledger verknüpfen
...
EXCEPTION WHEN OTHERS THEN
    -- Bei Fehler: Automatisches ROLLBACK durch PostgreSQL
    RAISE;
END;
$$;
