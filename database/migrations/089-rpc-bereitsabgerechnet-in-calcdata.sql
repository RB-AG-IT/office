-- Migration 089: bereitsAbgerechnet in calculation_data speichern
-- Fix: PDF zeigt keine Abzüge weil bereitsAbgerechnet nicht gespeichert wurde
        ...
        IF jsonb_array_length(COALESCE(input_data->'sondierungPositionen', '[]'::JSONB)) > 0 THEN
            INSERT INTO invoices (
                ...
                jsonb_build_object(
                    ...
                    'bereitsAbgerechnet', COALESCE(input_data->'bereitsAbgerechnet', '[]'::JSONB),
        ...
        LOOP
            INSERT INTO invoices (
                ...
                jsonb_build_object(
                    ...
                    'bereitsAbgerechnetZAs', COALESCE(v_rechnung->'bereitsAbgerechnetZAs', '[]'::JSONB),
                    'bereitsAbgerechnetSumme', v_rechnung->'bereitsAbgerechnetSumme'
                )
            ) RETURNING id INTO v_new_invoice_id;
...
COMMENT ON FUNCTION create_drk_invoice IS 'Erstellt DRK-Kundenrechnungen mit bereitsAbgerechnet in calculation_data';
