-- Migration 051: Fix RPC function - korrigiert invoice_id zu invoice_id_vorschuss
-- und entfernt stornorucklage_tracking Referenz (Tabelle in Migration 041 gelöscht)
